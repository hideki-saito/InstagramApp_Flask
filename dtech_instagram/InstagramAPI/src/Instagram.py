...
class Instagram:
    def __init__(self, username, password, debug=False, IGDataPath=None):
        ...
        self.debug = debug
        self.device_id = SignatureUtils.generateDeviceId(hashlib.md5(username.encode("utf-8") + password.encode("utf-8")))
        ...
        if IGDataPath is not None:
            ...
            if not os.path.isdir(self.IGDataPath):
                os.mkdir(self.IGDataPath, 0o0777)
    ...
    def megaphoneLog(self):
        ...
        return MegaphoneLogResponse(self.http.request('megaphone/log/', (data))[1])
